...
export class SasukeV2 {
  ...
  constructor(gameManager: GameManager, pos: Position) {
    ...
    // 0 1 2 3 idle
    const idleAnim: Animation = new Animation(
      'idle',
      4,
      'sasuke/idle-left.png',
      'sasuke/idle-right.png',
      81,
      81,
      81 * this.scale,
      81 * this.scale
    ...
    const runAnim: Animation = new Animation(
      'run',
      6,
      'sasuke/run-left.png',
      'sasuke/run-right.png',
      81,
      81,
      81 * this.scale,
      81 * this.scale
    ...
    const flyAnim: Animation = new Animation(
      'fly',
      2,
      'sasuke/fly-left.png',
      'sasuke/fly-right.png',
      81,
      81,
      81 * this.scale,
      81 * this.scale
    ...
    const attack1Anim: Animation = new Animation(
      'attack-1',
      4,
      'sasuke/attack-1-left.png',
      'sasuke/attack-1-right.png',
      122,
      81,
      122 * this.scale,
      81 * this.scale
    ...
    this.animations = [idleAnim, runAnim, flyAnim, attack1Anim];
  ...
  draw(ctx: CanvasRenderingContext2D) {
    ...
    this.animations[this.currentState].draw(
      ctx,
      this.indFrame,
      this.dir,
      px,
