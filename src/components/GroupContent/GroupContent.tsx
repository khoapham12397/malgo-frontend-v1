...
import { createPostGroup, loadCurrentPost, loadPosts, MESSAGE_TYPE } from "../../state/actions/chatAction";
...
function SearchBar() {
    ...
    return (
      <div className='search-bar'>
        ...
        <ModalWritePost handleSubmitThread={handleSubmitThread} type='grouppost'/>
      </div>
    );
  }
export const GroupContent = () =>{
    ...
    const currentGeneralSessionId= useSelector((state:RootState)=>state.chat.currentGeneralSessionId);
    ...
    return (
        ...
        {currentGroupMode!==GROUP_MODE.GENERAL_CHAT?<div className={currentGroupMode===GROUP_MODE.POST_SMALL?'post-list':'post-list-large'}>
              ...
              </div>:''}
              {
                ...
                <ChatContainer
                    sessionId={currentGroupMode===GROUP_MODE.GENERAL_CHAT?currentGeneralSessionId:currentPost?currentPost.id:null} 
