...
export const MemberList = ()=>{
    ...
    const onlineUsers = members?members.filter(item=> item.isOnline==true && item.username!==myUsername ):null;
    const offlineUsers = members?members.filter(item=> item.isOnline!=true && item.username!==myUsername):null;
