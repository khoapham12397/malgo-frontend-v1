...
export const ChatContainer = ({sessionId, postData,typeChat }: ChatContainerProps)=>{
    ...
    return (<div style={{position:'relative', height:"100%"}}>
      ...
      <div className='chat-content'>
        {typeChat===MESSAGE_TYPE.MESSAGE_P2P?<div style={{height: '50px'}}/>:''}
      ...
      <div style={{height: chatFormRef.current?(chatFormRef.current.offsetHeight+150):150}}/>
    </div>)
  }