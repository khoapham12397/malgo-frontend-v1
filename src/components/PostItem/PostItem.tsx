    ...
    <div className='post-item'>
      ...
      <div>
        ...
        <div className='d-flex'>
          <img src={getAvatarLink(postData.authorId)} className='avatar-icon' />
        ...
        <div>
          ...
          <img
            width={400}
            height='auto'
            src='https://media.discordapp.net/attachments/1119239110176018513/1119239110821949612/image.png?width=707&height=603'
          />
        </div>
      </div>
    </div>
