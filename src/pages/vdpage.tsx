...
export const VDPage = ()=>{
    ...
    const task1 = () =>{
        ...
        const data = {
            language_id: 54,
            source_code: "I2luY2x1ZGU8Yml0cy9zdGRjKysuaD4KdXNpbmcgbmFtZXNwYWNlIHN0ZDsKaW50IG1haW4oKXsKICAgIGludCBuLHg7CiAgICBjaW4gPj4gbjsKICAgIGZvcihpbnQgaT0wO2k8bjtpKyspIHsKICAgICAgICBjaW4+Png7CiAgICAgICAgY291dDw8IHgrMTw8ZW5kbDsKICAgIH0KICAgIAogICAgcmV0dXJuIDA7Cn0=",
            stdin: "",
    ...
    return <>
        ...
        <Table>
            <tbody>
            {submissionList.map(item=> <tr key ={item.id}>
                <td>{item.id}</td>
                <td>{item.status}</td>
                </tr>)}
