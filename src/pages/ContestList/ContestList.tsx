    ...
    <div className="main-container">
        <div style={{width: '28%'}}>
            ...
            <ul className="category-lst">
                <li className="item">Beginer <span className="rated-range">(0-999)</span></li>
                <li className="item">Intermediate <span className="rated-range">(1000-1499)</span></li>
                <li className="item">Advance <span className="rated-range">(1500-1999)</span></li>
                <li className="item">Master <span className="rated-range">(2000-2499)</span></li>
                <li className="item">Grandmaster <span className="rated-range">(2500-2999)</span></li>
                <li className="item">Legendary <span className="rated-range">(3000-3499)</span></li>
            </ul>
        </div>
    <div className="box">
        ...
        <div className="header">Live Contest</div>
            ...
            <Table className="tbl-contest"> 
                ...
                <tbody>
                    ...
                    <tr key = {item.id}>
                        <td className='link'>{(new Date(item.startTime)).toLocaleString()}</td>
                        <td className="link"><Link to ={"/singlecontest/"+ item.id} className='link'> Ⓐ ◉ {item.title} </Link></td>
                        <td>01:40</td>
                        <td>-1999</td>
                    </tr>
                    )}
                    <tr>
                        <td className='link'>{(new Date(Date.now())).toLocaleString()}</td>
                        <td className="link"> Ⓐ ◉ freee Programming Contest 2023（AtCoder Beginner Contest 310） </td>
                        <td>01:40</td>
                        <td>-1999</td>
                    </tr>
                    <tr>
            ...
            <Table className="tbl-contest"> 
                ...
                <tbody>
                    ...
                    <tr key = {item.id}>
                        <td className='link'>{(new Date(item.startTime)).toLocaleString()}</td>
                        <td className="link"><Link to ={"singlecontest/"+ item.id}> Ⓐ ◉ {item.title} </Link></td>
                        <td>01:40</td>
                        <td>-1999</td>
                    </tr>
                    )}
