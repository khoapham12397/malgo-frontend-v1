...
import {  initSocketClient,  loadChatSessionP2PList,  loadGroups, loadInitFriendList,  } from '../../state/actions/chatAction';
...
const GroupPage = () => {
    ...
    return(
        ...
        <div className='control-bar'>
          <div className= {pageMode===GROUP_PAGE_MODE.CHAT_P2P?'control-item chosen2':'control-item'} 
            onClick={()=>handleChangeMode(GROUP_PAGE_MODE.CHAT_P2P)}>
            <BiMessage size={24}/>  
          </div>
          <div className={pageMode===GROUP_PAGE_MODE.GROUP?'control-item chosen2':'control-item'} 
          ...
          <div className={pageMode===GROUP_PAGE_MODE.GROUP?'side-bar':'side-bar-large'}>
          ...
          {currentSessionIdP2P?<ChatContainer 
            postData={null} 
